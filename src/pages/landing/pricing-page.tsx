...
const PLANS = [
  {
    ...
    features: [
      "25 active MBLs",
      "Standard scrape cadence",
      "Dashboard access",
      "Community support",
      "7-day scrape log retention",
    ],
    cta: "Get Started",
    highlighted: false,
  },
  {
    ...
    price: "$99",
    period: "/month",
    desc: "For forwarders and drayage ops.",
    features: [
      "500 active MBLs",
      "Accelerated scrape cadence (ETA-aware)",
      "Terminal visibility (LA/LB)",
      "Webhooks (arrival, ETA, LFD)",
      "REST API + X-API-Key",
      "Priority support",
      "30-day scrape log retention",
  ...
  },
  {
    ...
    price: "Custom",
    period: "",
    desc: "For SaaS builders and global 3PLs.",
    features: [
      "Unlimited MBLs",
