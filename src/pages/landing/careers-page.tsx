...
const JOBS: Job[] = [
  ...
  { title: "Scraping Engineer (Playwright)", department: "Engineering", location: "Remote", type: "Full-time" },
  ...
  { title: "Solutions Engineer (Logistics)", department: "Sales", location: "Los Angeles, CA", type: "Full-time" },
    ...
    <div className="pt-14">
        ...
        <div className="relative mx-auto max-w-[1200px] px-6 text-center">
          ...
          <FadeIn delay={0.2}>
            <p className="mx-auto mt-6 max-w-lg text-lg text-resend-muted">
              Join a small, focused team reimagining how freight moves through
              carrier portals, terminals, and your TMS. We value craftsmanship,
              speed, and deep care for the operator experience.
            </p>
          </FadeIn>
        </div>
      </section>
      ...
      <section className="py-20">
        <div className="mx-auto max-w-[1200px] px-6">
          <FadeIn>
            <h2 className="mb-12 font-heading text-3xl font-normal text-white">Why OMNIQ</h2>
          </FadeIn>
      ...
      <section className="py-24 text-center">
        <FadeIn>
          ...
          <p className="mt-3 text-resend-muted">Send us an email at careers@omniqgroup.com</p>
          <a
            href="mailto:careers@omniqgroup.com"
