...
const POSTS = [
  {
    title: "Introducing TMS Pro Dispatch v2",
    desc: "Delivery orders, leg planning, driver schedules, and webhook events in one platform. Here's what shipped and what's next.",
    date: "Apr 14, 2026",
    tag: "Announcement",
    image: "https://picsum.photos/600/340?random=1",
  },
  {
    title: "How We Keep Driver Schedules in Sync",
    desc: "A deep dive into our realtime dispatch board, WebSocket cache invalidation, and why optimistic UI matters at the leg level.",
    date: "Apr 10, 2026",
    tag: "Engineering",
    image: "https://picsum.photos/600/340?random=2",
  },
  {
    title: "Per-Diem Alerts Before Dispatch, Not After",
    desc: "How one webhook into Slack helped a LA drayage carrier catch slipping legs and reduce chargebacks by 72%.",
    date: "Apr 5, 2026",
    tag: "Case Study",
    image: "https://picsum.photos/600/340?random=3",
  },
  {
    title: "The State of Drayage Operations in 2026",
    desc: "Our annual report on dispatch automation, driver retention, and where TMS tools still leave gaps.",
    date: "Mar 28, 2026",
    tag: "Research",
  ...
  {
    title: "Behind the Terminal Appointment Integrations",
    desc: "eModal, APM, Fenix, YTI, and LBCT each speak a different language. Here's how we normalize them for dispatchers.",
    date: "Mar 12, 2026",
    tag: "Engineering",
    ...
    <div className="pt-14">
      <section className="py-32">
        <div className="mx-auto max-w-[1200px] px-6">
          ...
          <FadeIn delay={0.1}>
            <p className="mt-4 text-lg text-resend-muted">News, updates, and stories from the TMS Pro team.</p>
          </FadeIn>
